...
library NFTIMEArt {
    ...
    /// @notice Generate the complete SVG code for a given Check.
    /// @param _x The check to render.
    /// @param _y The check to render.
    /// @param _height The check to render.
    /// @param _width The check to render.
    /// @param _fontSize The check to render.
    /// @param _value The check to render.
